...
\begin{figure}[t]
  \centering  
  \subfigure[]{\includegraphics[width=6cm]{Figures/acc.pdf}}
  \subfigure[]{\includegraphics[width=6cm]{Figures/rt.pdf}}
...
\begin{figure}[t]
  \centering  
  \subfigure[]{\includegraphics[width=6cm]{Figures/pilot_prior_plot.pdf}}
  \subfigure[]{\includegraphics[width=6cm]{Figures/pilot_plot.pdf}}
...
\begin{figure}[t]
  \centering  
  \subfigure[]{\includegraphics[width=6cm]{Figures/acc_main.pdf}}
  \subfigure[]{\includegraphics[width=6cm]{Figures/rt_main.pdf}}
  \caption{The distribution of (a) accuracy and (b) reaction time measures in the split-half visual search task. Note that the $y$-axis for (b) has been $\log_2$-scaled. Dots represent points classed as outliers, defined as being below or above $1.5 \times$ the inter-quartile range away from the first or third quartile.}
...
\begin{figure}[t]
  \centering  
  \subfigure[]{\includegraphics[width=6cm]{Figures/strat_hist.pdf}}
  \subfigure[]{\includegraphics[width=6cm]{Figures/pre_crastinate.pdf}}
...
\begin{figure}[t]
  \centering  
\subfigure[]{\includegraphics[width=6cm]{Figures/post_plot.pdf}}
\subfigure[]{\includegraphics[width=6cm]{Figures/pre_cras_consc.pdf}}
...
\begin{figure}[t]
  \centering  
\includegraphics[width=10cm]{Figures/exp_strat.pdf}
